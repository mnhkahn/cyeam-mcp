...
- AI
- Claude
filename: 2026-04-05-claude-install.md
title: Claude Code安装与使用完全指南：从OpenRouter到黄大善人模型
description: 详细介绍Claude Code的安装方法，包括使用OpenRouter模型的环境变量配置和启动步骤，以及通过claude-code-router代理黄大善人模型的完整流程。文章还提供了Claude
  Code的常用快捷键列表，帮助开发者高效使用这一AI编码工具。
category: AI
layout: post
