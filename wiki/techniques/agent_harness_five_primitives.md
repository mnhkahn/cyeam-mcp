...
sources: ["d58ae4358780"]
original_filename: 2026-06-01-agent-harness-five-primitives.md
...
解析 AI 编码代理 Harness 的五个核心源语——Skill、Rule、Hook、Memory、Eval，如何通过递进防御将概率性模型转化为可靠的工程系统。
