...
sources: ["a89003290b67"]
original_filename: 2026-06-06-superpowers-claude-code-injection.md
...
# Superpowers 如何“插装”进 Claude Code：注入机制与双环执法架构

拆解 Superpowers 如何通过 Claude Code 原生 Plugin + Hooks 注入强制性 Meta-Skill，以及它「离线 eval 执法 + 运行时行为塑形」的双环架构——运行时几乎不执行代码，真正的强制力来自离线评估闭环。
