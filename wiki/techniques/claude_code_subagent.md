...
related: ["[[Large Language Models]]", "[[Model Context Protocol]]"]
sources: ["1ad3cf3f9ace"]
original_filename: 2026-06-22-claude-code-subagent.md
description: 拆解 Claude Code 中 Subagent 的触发条件、普通子Agent与Fork子Agent的核心差异、Agent Type 实现方式及结果回流机制，一文看懂主Agent如何派生子任务。
---

# Claude Code 的 Subagent 机制：触发条件、类型对比与结果回流

拆解 Claude Code 中 Subagent 的触发条件、普通子Agent与Fork子Agent的核心差异、Agent Type 实现方式及结果回流机制，一文看懂主Agent如何派生子任务。
